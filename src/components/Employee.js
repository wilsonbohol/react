...
function Employee(props) {
  return (
    <>
      <div class="min-w-[350px] max-w-[50px] py-8 m-2 px-8 max-w-sm bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
        <img
